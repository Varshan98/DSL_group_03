...
HD_PWD='D:/SUTD/Term 8/DSL/Projects/Lab_1/Lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T01_Basys3_LogicGate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T01_Basys3_LogicGate.tcl -notrace
