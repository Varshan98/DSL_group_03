...
HD_PWD='D:/SUTD/Term 8/DSL/Projects/Lab_1/Lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T01_Basys3_LogicGate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T01_Basys3_LogicGate.tcl
